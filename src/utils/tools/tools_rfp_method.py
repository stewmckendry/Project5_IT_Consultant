...
def evaluate_collaboration_approach(agent) -> str:
    instructions = f"""
...
def check_discovery_approach(agent) -> str:
    """
...
def check_requirements_approach(agent) -> str:
    """
    Evaluates whether the vendor's approach to requirements gathering is comprehensive and appropriate.
    """
    instructions = (
...
def check_design_approach(agent) -> str:
    """
    Evaluates the vendor's approach to system and solution design.
    """
    instructions = (
...
def check_build_approach(agent) -> str:
    """
    Evaluates the vendor’s approach for the Build phase of delivery.
    """
    instructions = (
...
def check_test_approach(agent) -> str:
    """
...
def check_deployment_approach(agent) -> str:
    """
...
def check_operate_approach(agent) -> str:
    """
...
def check_agile_compatibility(agent) -> str:
    """
...
def check_accelerators_and_tools(agent) -> str:
    """
